...
class TelaDeLembrarSenha5 extends StatefulWidget {

  final MaterialColor colorPalette;

  const TelaDeLembrarSenha5({Key? key, required this.colorPalette}) : super(key: key);

  @override
  State<TelaDeLembrarSenha5> createState() => _TelaDeLembrarSenha5State();
}

class _TelaDeLembrarSenha5State extends State<TelaDeLembrarSenha5> {
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: CampoDeDadosEstaticoInvisivel(textoSuperior: "Senha atual", password: "Nada"),
                ),
                Padding(
                  padding: const EdgeInsets.only(bottom: 32.0),
                  child: CampoDeLoginVisivel(textoSuperior: "Nova Senha", emailAddress: password),
                ),
                CampoDeLoginVisivel(textoSuperior: "Confirmar Senha", emailAddress: passwordConfirm),
                const Padding(
                  ...
                  child: SizedBox(
                    ...
                    height: 125,
                    child: Image(
                      image: AssetImage("assets/lembrar_senha/desenhos.png"),
